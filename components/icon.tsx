...
export default function Icon() {
  const { socialmedia, container, h1, sosmedlink, fillcurrent, sosiaLink } =
    style;
  return (
    <>
      <div className={`${socialmedia}`}>
        <div className={`${container}`}>
          <h1 className={`${h1}`}>Our Social Media</h1>
          <div className={`${sosmedlink}`}>
            ...
            <a href="mailto:emnoerelevator@gmail.com" className="sosiaLink">
              <svg
                className={`${fillcurrent}`}
                role="img"
                viewBox="0 0 24 24"
